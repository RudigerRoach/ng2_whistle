...
export class DashboardComponent implements OnInit {
  ...
  constructor(private mapsAPILoader: MapsAPILoader, public toasterService: ToasterService, public authService: AuthService) {
  }
  ...
  sortedAlerts(): Alert[] {
    return this.alerts.sort((a: Alert, b: Alert) => {
